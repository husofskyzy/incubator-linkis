    ...
    public JobInfoResult queryJobInfo(String user, String taskID)
        ...
        while (retryTime++ < MAX_RETRY_TIME) {
            try {
                ...
                logger.debug("job-info: " + Utils.toJson(jobInfoResult));
    ...
    public JobLogResult queryRunTimeLogFromLine(
        ...
        while (retryTime++ < MAX_RETRY_TIME) {
            try {
                ...
                logger.debug("runtime-log-result:" + Utils.toJson(logResult));
                ...
                openLogResult =
                        client.openLog(
                                OpenLogAction.newBuilder()
                                        ...
                                        .setProxyUser(user)
                                        .build());
                logger.debug("persisted-log-result:" + Utils.toJson(openLogResult));
    ...
    public ResultSetResult queryResultSetGivenResultSetPath(
        ...
        while (retryTime++ < MAX_RETRY_TIME) {
            try {
                ...
                logger.debug("resultset-result:" + Utils.toJson(result));
    ...
    public JobKillResult kill(String user, String taskId, String execId)
        ...
        while (retryTime++ < MAX_RETRY_TIME) {
            try {
                ...
                logger.debug("job-kill-result:" + Utils.toJson(result));
                if (result == null || 0 != result.getStatus()) {
                    String reason;
                    if (result == null) {
