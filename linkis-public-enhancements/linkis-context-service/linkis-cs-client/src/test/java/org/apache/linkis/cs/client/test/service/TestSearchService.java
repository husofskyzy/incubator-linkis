...
public class TestSearchService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LinkisHAWorkFlowContextID contextID = new LinkisHAWorkFlowContextID();
        {
            ...
            System.out.println(JacksonUtils.objectToJsonFormat(contextID));
            ...
            System.out.println(JacksonUtils.toJson(resource));
...

        {
            ...
            System.out.println(JacksonUtils.toJson(flowInfoObject));
        }

        BMLResource bmlResource =
                searchService.searchContext(contextID, "cooper", "sql", LinkisBMLResource.class);
        contextClient.close();
        System.out.println(JacksonUtils.toJson(bmlResource));
    }
}
